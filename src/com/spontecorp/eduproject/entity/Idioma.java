...
public class Idioma implements Serializable {
    ...
    @JoinTable(name = "instituto_has_idioma", joinColumns = {
        @JoinColumn(name = "idioma_id", referencedColumnName = "id")}, inverseJoinColumns = {
    ...
    public String toString() {
        return "com.spontecorp.eduproject.entity.Idioma[ id=" + id + " ]";
    }
