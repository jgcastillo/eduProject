...
@NamedQueries({
    ...
    @NamedQuery(name = "Zip.findById", query = "SELECT z FROM Zip z WHERE z.id = :id"),
    @NamedQuery(name = "Zip.findByZip", query = "SELECT z FROM Zip z WHERE z.zip = :zip")})
public class Zip implements Serializable {
    ...
    public String toString() {
        return "com.spontecorp.eduproject.entity.Zip[ id=" + id + " ]";
    }
